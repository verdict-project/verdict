...
public class TpchSelectQueryToSqlTest {
  ...
  public void Query1Test() throws VerdictDBException {
    ...
    List<UnnamedColumn> operand1 =
        Arrays.<UnnamedColumn>asList(ConstantColumn.valueOf(1), new BaseColumn("t", "l_discount"));
    List<UnnamedColumn> operand2 =
        Arrays.<UnnamedColumn>asList(
            new BaseColumn("t", "l_extendedprice"), new ColumnOp("subtract", operand1));
    List<UnnamedColumn> operand3 =
        Arrays.<UnnamedColumn>asList(ConstantColumn.valueOf(1), new BaseColumn("t", "l_tax"));
    ...
    SelectQuery relation =
        SelectQuery.create(
            Arrays.<SelectItem>asList(
                ...
                new AliasedColumn(
                    new ColumnOp("sum", new BaseColumn("t", "l_quantity")), "sum_qty"),
                new AliasedColumn(
                    new ColumnOp("sum", new BaseColumn("t", "l_extendedprice")), "sum_base_price"),
                new AliasedColumn(
                    new ColumnOp("sum", new ColumnOp("multiply", operand2)), "sum_disc_price"),
                new AliasedColumn(
                    new ColumnOp("sum", new ColumnOp("multiply", operand4)), "sum_charge"),
                new AliasedColumn(
                    new ColumnOp("avg", new BaseColumn("t", "l_quantity")), "avg_qty"),
                new AliasedColumn(
                    new ColumnOp("avg", new BaseColumn("t", "l_extendedprice")), "avg_price"),
                new AliasedColumn(
                    new ColumnOp("avg", new BaseColumn("t", "l_discount")), "avg_disc"),
  ...
  public void Query2Test() throws VerdictDBException {
    ...
    SelectQuery relation =
        SelectQuery.create(
            ...
            from);
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("p", "p_partkey"), new BaseColumn("ps", "ps_partkey"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("s", "s_suppkey"), new BaseColumn("ps", "ps_suppkey"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("p", "p_size"), ConstantColumn.valueOf("':1'"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "like",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("p", "p_type"), ConstantColumn.valueOf("'%:2'"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("s", "s_nationkey"), new BaseColumn("n", "n_nationkey"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("n", "n_regionkey"), new BaseColumn("r", "r_regionkey"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("r", "r_name"), ConstantColumn.valueOf("':3'"))));
    List<AbstractRelation> subqueryFrom =
        Arrays.<AbstractRelation>asList(partsupp, supplier, nation, region);
  ...
  public void Query3Test() throws VerdictDBException {
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("c", "c_mktsegment"), ConstantColumn.valueOf("':1'"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("c", "c_custkey"), new BaseColumn("o", "o_custkey"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l", "l_orderkey"), new BaseColumn("o", "o_orderkey"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "less",
            Arrays.<UnnamedColumn>asList(
  ...
  public void Query4Test() throws VerdictDBException {
    ...
    subquery.addFilterByAnd(
        new ColumnOp(
            "less",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l", "l_commitdate"), new BaseColumn("l", "l_receiptdate"))));
  ...
  public void Query5Test() throws VerdictDBException {
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l", "l_suppkey"), new BaseColumn("s", "s_suppkey"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("c", "c_nationkey"), new BaseColumn("s", "s_nationkey"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("r", "r_name"), ConstantColumn.valueOf("':1'"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "greaterequal",
            Arrays.<UnnamedColumn>asList(
  ...
  public void Query6Test() throws VerdictDBException {
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "less",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l", "l_quantity"), ConstantColumn.valueOf("':3'"))));
    relation.addLimit(ConstantColumn.valueOf(1));
    String expected =
        "select "
  ...
  public void Query7Test() throws VerdictDBException {
    ...
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("s", "s_suppkey"), new BaseColumn("l", "l_suppkey"))));
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("o", "o_orderkey"), new BaseColumn("l", "l_orderkey"))));
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
    ...
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("s", "s_nationkey"), new BaseColumn("n1", "n_nationkey"))));
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("c", "c_nationkey"), new BaseColumn("n2", "n_nationkey"))));
    subquery.addFilterByAnd(
        new ColumnOp(
            "or",
            Arrays.<UnnamedColumn>asList(
                new ColumnOp(
                    ...
                    Arrays.<UnnamedColumn>asList(
                        ...
                        new ColumnOp(
                            "equal",
                            Arrays.<UnnamedColumn>asList(
                                new BaseColumn("n2", "n_name"), ConstantColumn.valueOf("':2'"))))),
                new ColumnOp(
                    "and",
                    Arrays.<UnnamedColumn>asList(
                        new ColumnOp(
  ...
  public void Query8Test() throws VerdictDBException {
    ...
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("p", "p_partkey"), new BaseColumn("l", "l_partkey"))));
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
    ...
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("o", "o_custkey"), new BaseColumn("c", "c_custkey"))));
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("c", "c_nationkey"), new BaseColumn("n1", "n_nationkey"))));
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("n1", "n_regionkey"), new BaseColumn("r", "r_regionkey"))));
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("r", "r_name"), ConstantColumn.valueOf("':2'"))));
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("s", "s_nationkey"), new BaseColumn("n2", "n_nationkey"))));
    subquery.addFilterByAnd(
        new ColumnOp(
            "between",
            Arrays.<UnnamedColumn>asList(
    ...
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("p", "p_type"), ConstantColumn.valueOf("':3'"))));
                            ...
                            new ColumnOp(
                                ...
                                new ColumnOp(
                                    ...
                                    Arrays.<UnnamedColumn>asList(
                                        ...
                                        ConstantColumn.valueOf(0)))),
                            new ColumnOp("sum", new BaseColumn("all_nations", "volume")))),
                    "mkt_share")),
            subquery);
  ...
  public void Query9Test() throws VerdictDBException {
    ...
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("ps", "ps_suppkey"), new BaseColumn("l", "l_suppkey"))));
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("ps", "ps_partkey"), new BaseColumn("l", "l_partkey"))));
    subquery.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
  ...
  public void Query10Test() throws VerdictDBException {
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l", "l_returnflag"), ConstantColumn.valueOf("'R'"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("c", "c_nationkey"), new BaseColumn("n", "n_nationkey"))));
    relation.addGroupby(
        Arrays.<GroupingAttribute>asList(
  ...
  public void Query11Test() throws VerdictDBException {
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("ps", "ps_suppkey"), new BaseColumn("s", "s_suppkey"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("n", "n_name"), ConstantColumn.valueOf("':1'"))));
  ...
  public void Query12Test() throws VerdictDBException {
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "less",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l", "l_shipdate"), new BaseColumn("l", "l_commitdate"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "greaterequal",
            Arrays.<UnnamedColumn>asList(
  ...
  public void Query14Test() throws VerdictDBException {
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l", "l_partkey"), new BaseColumn("p", "p_partkey"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "greaterequal",
            Arrays.<UnnamedColumn>asList(
  ...
  public void Query15Test() throws VerdictDBException {
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("s", "s_suppkey"), new BaseColumn("r", "supplier_no"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("r", "total_revenue"), SubqueryColumn.getSubqueryColumn(subquery))));
  ...
  public void Query16Test() throws VerdictDBException {
    ...
    SelectQuery relation =
        SelectQuery.create(
            Arrays.asList(
                ...
                new AliasedColumn(
                    new ColumnOp("countdistinct", new BaseColumn("ps", "ps_suppkey")),
                    "supplier_cnt")),
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "notequal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("p", "p_brand"), ConstantColumn.valueOf("':1'"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "notlike",
            Arrays.<UnnamedColumn>asList(
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "notin",
            Arrays.asList(
                new BaseColumn("ps", "ps_suppkey"), SubqueryColumn.getSubqueryColumn(subquery))));
    relation.addGroupby(
        Arrays.<GroupingAttribute>asList(
  ...
  public void Query17Test() throws VerdictDBException {
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("part_agg", "agg_partkey"), new BaseColumn("l", "l_partkey"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("p", "p_container"), ConstantColumn.valueOf("':2'"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "less",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l", "l_quantity"), new BaseColumn("part_agg", "avg_quantity"))));
    relation.addLimit(ConstantColumn.valueOf(1));
    String expected =
        "select "
  ...
  public void Query18Test() throws VerdictDBException {
    ...
    SelectQuery relation =
        SelectQuery.create(
            ...
            Arrays.asList(customer, orders, lineitem));
    SelectQuery subquery =
        SelectQuery.create(Arrays.<SelectItem>asList(new BaseColumn("l", "l_orderkey")), lineitem);
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "in",
            Arrays.asList(
                new BaseColumn("o", "o_orderkey"), SubqueryColumn.getSubqueryColumn(subquery))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
  ...
  public void Query20Test() throws VerdictDBException {
    ...
    SelectQuery relation =
        SelectQuery.create(
            Arrays.<SelectItem>asList(
                new BaseColumn("s", "s_name"), new BaseColumn("s", "s_address")),
    ...
    subsubquery.addGroupby(
        Arrays.<GroupingAttribute>asList(
            new AliasReference("l_partkey"), new AliasReference("l_suppkey")));
    subsubquery.setAliasName("agg_lineitem");
    SelectQuery subquery =
        SelectQuery.create(
            Arrays.<SelectItem>asList(new BaseColumn("ps", "ps_suppkey")),
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "in",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("s", "s_suppkey"), SubqueryColumn.getSubqueryColumn(subquery))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
    ...
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("n", "n_name"), ConstantColumn.valueOf("':3'"))));
  ...
  public void Query21Test() throws VerdictDBException {
    ...
    SelectQuery relation =
        SelectQuery.create(
            Arrays.asList(
                new BaseColumn("s", "s_name"), new AliasedColumn(new ColumnOp("count"), "numwait")),
            Arrays.asList(supplier, lineitem, orders, nation));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("s", "s_suppkey"), new BaseColumn("l1", "l_suppkey"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("o", "o_orderkey"), new BaseColumn("l1", "l_orderkey"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("o", "o_orderstatus"), ConstantColumn.valueOf("'F'"))));
    relation.addFilterByAnd(
        new ColumnOp(
            "greater",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l1", "l_receiptdate"), new BaseColumn("l1", "l_commitdate"))));
    ...
    subquery1.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l2", "l_orderkey"), new BaseColumn("l1", "l_orderkey"))));
    subquery1.addFilterByAnd(
        new ColumnOp(
            "notequal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l2", "l_suppkey"), new BaseColumn("l1", "l_suppkey"))));
    ...
    subquery2.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l3", "l_orderkey"), new BaseColumn("l1", "l_orderkey"))));
    subquery2.addFilterByAnd(
        new ColumnOp(
            "notequal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l3", "l_suppkey"), new BaseColumn("l1", "l_suppkey"))));
    subquery2.addFilterByAnd(
        new ColumnOp(
            "greater",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("l3", "l_receiptdate"), new BaseColumn("l3", "l_commitdate"))));
  ...
  public void Query22Test() throws VerdictDBException {
    ...
    subsubquery1.addFilterByAnd(
        new ColumnOp(
            "greater",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("c", "c_acctbal"), ConstantColumn.valueOf("0.00"))));
    subsubquery1.addFilterByAnd(
        new ColumnOp(
            "in",
            Arrays.<UnnamedColumn>asList(
    ...
    SelectQuery subsubquery2 =
        SelectQuery.create(
            Arrays.<SelectItem>asList(new AsteriskColumn()), new BaseTable("tpch", "orders", "o"));
    subsubquery2.addFilterByAnd(
        new ColumnOp(
            "equal",
            Arrays.<UnnamedColumn>asList(
                new BaseColumn("o", "o_custkey"), new BaseColumn("c", "c_custkey"))));
    subquery.addFilterByAnd(
        new ColumnOp("notexists", SubqueryColumn.getSubqueryColumn(subsubquery2)));
    ...
    SelectQuery relation =
        SelectQuery.create(
            Arrays.asList(
                ...
                new AliasedColumn(
                    new ColumnOp("sum", new BaseColumn("custsale", "c_acctbal")), "totacctbal")),
            subquery);
