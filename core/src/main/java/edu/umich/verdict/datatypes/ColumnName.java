...
public class ColumnName {
     ...
     * 
     * @param columnName
     *            a possibly full column name including table name and column name
     * @return
     */
    ...
    // private static Set<String> columnsToTables(List<TableUniqueName>
    // tableSources) {
     ...
     */
    private static Pair<TableUniqueName, String> effectiveTableSourceForColumn(VerdictJDBCContext vc, String tableName,
            String columnName, List<Pair<TableUniqueName, String>> tableSources) throws VerdictException {
        if (tableName != null) {
     ...
     * @param vc
     * @param tableSources
     *            Pairs of a table source name and its alias
     * @param columnName
     * @return
     * @throws VerdictException
     */
    public static ColumnName uname(VerdictJDBCContext vc, List<Pair<TableUniqueName, String>> tableSources,
            String columnName) throws VerdictException {
        Pair<String, String> tc = parseTableAndColumnName(columnName);
        Pair<TableUniqueName, String> tableNameAndAlias = effectiveTableSourceForColumn(vc, tc.getLeft(), tc.getRight(),
                tableSources);
        String tableName = (tableNameAndAlias.getRight() == null) ? tableNameAndAlias.getLeft().getTableName()
                : tableNameAndAlias.getRight();
