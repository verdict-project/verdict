...
public class CreateTableQuery extends Query {
    ...
    public void compute() throws VerdictException {
        ...
        // System.out.println(String.format("col name: %s, col type: %s",
        // colDef.getKey(), colDef.getValue()));
        // }
        //
        // for (Map.Entry<String, String> e : parser.getOptions().entrySet()) {
        // System.out.println(String.format("option: %s, value: %s", e.getKey(),
        // e.getValue()));
        // }
        //
        // return null;
...
class CreateTableQueryParser extends VerdictSQLBaseVisitor<Void> {
    ...
    // @Override
    // public Void
    // visitCreate_table_option(VerdictSQLParser.Create_table_optionContext ctx) {
