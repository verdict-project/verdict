...
public class RedshiftThroughVerdictTest {
    ...
    public static void main(String[] args) throws VerdictException {
        ...
        // vc.executeJdbcQuery("set search_path = instacart100g,
        // instacart100g_verdict2");
        ...
        ////
        // startTime = System.currentTimeMillis();
        // vc.executeJdbcQuery("create 10% stratified sample of tpch500g.lineitem on
        // l_suppkey;");
        // endTime = System.currentTimeMillis();
        // System.out.println("\n\ncreate stratified sample of tpch500g.lineitem on
        // l_suppkey;");
        // System.out.println("That took " + (endTime - startTime) + " milliseconds
        // \n\n");

        // startTime = System.currentTimeMillis();
        // vc.executeJdbcQuery("create 0.5% universe sample of tpch500g.lineitem on
        // l_orderkey;");
        // endTime = System.currentTimeMillis();
        // System.out.println("\n\ncreate universe sample of tpch500g.lineitem on
        // l_orderkey;");
        // System.out.println("That took " + (endTime - startTime) + " milliseconds
        // \n\n");
        //
        ...
        //
        // startTime = System.currentTimeMillis();
        // vc.executeJdbcQuery("create 0.5% uniform sample of
        // instacart100g.order_products;");
        // endTime = System.currentTimeMillis();
        // System.out.println("\n\ncreate uniform sample of
        // instacart100g.order_products;");
        // System.out.println("That took " + (endTime - startTime) + " milliseconds
        // \n\n");
        //
        // startTime = System.currentTimeMillis();
        // vc.executeJdbcQuery("create 0.5% universe sample of instacart100g.orders on
        // order_id;");
        // endTime = System.currentTimeMillis();
        // System.out.println("\n\ncreate universe sample of instacart100g.orders on
        // order_id;");
        // System.out.println("That took " + (endTime - startTime) + " milliseconds
        // \n\n");
        //
        // startTime = System.currentTimeMillis();
        // vc.executeJdbcQuery("create 0.5% universe sample of
        // instacart100g.order_products on order_id;");
        // endTime = System.currentTimeMillis();
        // System.out.println("\n\ncreate universe sample of
        // instacart100g.order_products on order_id;");
        // System.out.println("That took " + (endTime - startTime) + " milliseconds
        // \n\n");
        ...
        // String q2 = "select order_hour_of_day, count(*) as c from
        // instacart100g.orders group by order_hour_of_day order by order_hour_of_day;";
        // String q3 = "SELECT product_name, count(*) as order_count FROM
        // instacart100g.order_products, instacart100g.orders, instacart100g.products
        // WHERE orders.order_id = order_products.order_id AND order_products.product_id
        // = products.product_id AND (order_dow = 0 OR order_dow = 1) GROUP BY
        // product_name ORDER BY order_count DESC LIMIT 5;";
        // String q4 = "SELECT departments.department_id, department, count(*) as
        // order_count FROM instacart100g.order_products, instacart100g.orders,
        // instacart100g.products, instacart100g.departments WHERE orders.order_id =
        // order_products.order_id AND order_products.product_id = products.product_id
        // AND products.department_id = departments.department_id GROUP BY
        // departments.department_id, department ORDER BY order_count DESC LIMIT 5;";
        // String q4_alias = "SELECT d.department_id, d.department, count(*) as
        // order_count FROM instacart100g.order_products as op, instacart100g.orders as
        // ord, instacart100g.products as p, instacart100g.departments as d WHERE
        // ord.order_id = op.order_id AND op.product_id = p.product_id AND
        // p.department_id = d.department_id GROUP BY d.department_id, d.department
